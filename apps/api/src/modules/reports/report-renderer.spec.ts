...
const model: ReportDocument = {
  ...
  criteria: [["Period", "2026-08-01 through 2026-08-31"], ["Scope", "All matching records"]], metrics: [["Total tickets", 114], ["Estimate", 0]], distributions: [{ title: "Client", items: [{ label: "ISFA", count: 114 }] }], activity: [{ period: "2026-08-01", created: 0, closed: 0 }], matched: 114,
