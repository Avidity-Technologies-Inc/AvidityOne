...
const CSS_BORDER = new RegExp(`^\\d{1,3}(\\.\\d{1,2})?(px|pt)\\s+(solid|dashed|dotted)\\s+(${CSS_COLOR.source.slice(2, -2)})$`);
  ...
  private sanitizeContent(input: string | null | undefined, emailSafe: boolean): string {
    ...
    return sanitizeHtml(input, {
      ...
      allowedAttributes: {
        ...
        table: ["width", ...(emailSafe ? [] : ["height"]), "cellpadding", "cellspacing", "border", "role", "align", "style"],
        td: ["width", ...(emailSafe ? [] : ["height"]), "valign", "align", "colspan", "rowspan", "style"],
        th: ["width", ...(emailSafe ? [] : ["height"]), "valign", "align", "colspan", "rowspan", "style"],
      ...
      allowedStyles: {
        "*": {
          ...
          // Email column widths carry signature spacing; constrain overflow in the viewer instead.
          width: [CSS_LENGTH],
